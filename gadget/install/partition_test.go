...
var mockOnDiskAndLaidoutStructureWritable = install.BuildOnDiskAndLaidoutStructure(
...
var mockOnDiskAndLaidoutStructureSave = install.BuildOnDiskAndLaidoutStructure(
	&gadget.OnDiskStructure{
		Node:        "/dev/node3",
		Name:        "Save",
...
var mockOnDiskAndLaidoutStructureWritableAfterSave = install.BuildOnDiskAndLaidoutStructure(
	&gadget.OnDiskStructure{
		Node: "/dev/node4",
		Name: "Writable",
		// expanded to fill the disk
...
func (s *partitionTestSuite) TestEnsureNodesExist(c *C) {
	...
	for _, tc := range []struct {
		...
		ds := []install.OnDiskAndLaidoutStructure{
			install.BuildOnDiskAndLaidoutStructure(

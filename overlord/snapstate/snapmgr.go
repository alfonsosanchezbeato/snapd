...
func (snapst *SnapState) IsComponentInSeqPtWithOtherSnapRevision(csi *snap.ComponentSideInfo, snapRev snap.Revision) bool {
	return snapst.Sequence.IsComponentInSeqPtWithOtherSnapRevision(csi, snapRev)
}

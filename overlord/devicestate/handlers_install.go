...
func (m *DeviceManager) doInstallFinish(t *state.Task, _ *tomb.Tomb) error {
	...
	bootWith := &boot.BootableSet{
		...
		// XXX Needed as part of recovery boot chain
		// TODO no recovery boot chain at all probably in this case
		RecoverySystemDir: filepath.Join("/var/lib/snapd/seed/systems", systemLabel),

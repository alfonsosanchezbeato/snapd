...
func (s *specSuite) TestSmoke(c *C) {
	...
	s.spec.AddLibDirs(dirs1)
	s.spec.AddLibDirs(dirs2)
	// no duplication of directories
	s.spec.AddLibDirs(dirs2)
	c.Assert(s.spec.LibDirs(), DeepEquals, map[string]bool{
		"/dir1/lib1": true, "/dir1/lib2": true, "/dir2/lib1": true, "/dir2/lib2": true})
}
...
func (s *specSuite) TestSpecificationIface(c *C) {
	...
	c.Assert(s.spec.LibDirs(), DeepEquals, map[string]bool{
		"/dir1/lib1": true, "/dir1/lib2": true, "/dir1/lib3": true, "/dir1/lib4": true})
}
